...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskDecisionOutcome (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    Name NVARCHAR(100) NOT NULL,
    Code NVARCHAR(50) NOT NULL,
    Description NVARCHAR(MAX),
    Sequence INT NOT NULL DEFAULT 100,
    IsTerminal BIT NOT NULL DEFAULT 1,
...
EXEC sp_addextendedproperty
    ...
    @value = N'Human-readable outcome label (e.g. Approved, Rejected, Approved With Conditions).',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecisionOutcome',
    @level2type = N'COLUMN', @level2name = N'Name';
GO
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Stable machine code for the outcome, used by orchestration code to map outcome to task status (e.g. Approved, Rejected, ApprovedWithConditions).',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecisionOutcome',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Display ordering for the outcome in decision pickers.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecisionOutcome',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'When 1, recording this outcome closes the approval (terminal). When 0, the decision is interim and the task remains open.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecisionOutcome',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'When 0, the outcome is hidden from new decision pickers but preserved on historical decisions.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecisionOutcome',
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskDecision (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    TaskID UNIQUEIDENTIFIER NOT NULL,
    OutcomeID UNIQUEIDENTIFIER NOT NULL,
    DecidedByPersonID UNIQUEIDENTIFIER,
    ...
    CONSTRAINT FK_TaskDecision_Task FOREIGN KEY (TaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
    CONSTRAINT FK_TaskDecision_Outcome FOREIGN KEY (OutcomeID) REFERENCES ${flyway:defaultSchema}.TaskDecisionOutcome(ID),
    CONSTRAINT FK_TaskDecision_DecidedByPerson FOREIGN KEY (DecidedByPersonID) REFERENCES __mj_BizAppsCommon.Person(ID),
    CONSTRAINT FK_TaskDecision_TaskAssignment FOREIGN KEY (TaskAssignmentID) REFERENCES ${flyway:defaultSchema}.TaskAssignment(ID)
);
GO

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'The task this decision was recorded against.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecision',
    @level2type = N'COLUMN', @level2name = N'TaskID';
GO
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'The decision outcome (FK to TaskDecisionOutcome).',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecision',
    @level2type = N'COLUMN', @level2name = N'OutcomeID';
GO
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'The Person who made the decision.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecision',
    @level2type = N'COLUMN', @level2name = N'DecidedByPersonID';
GO
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'When the decision was recorded.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecision',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Free-text rationale or conditions attached to the decision.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecision',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Optional link to the specific TaskAssignment this decision belongs to, for per-assignee decisions in multi-approver flows. Null for a task-level decision.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskDecision',
    @level2type = N'COLUMN', @level2name = N'TaskAssignmentID';
GO
...
ALTER TABLE ${flyway:defaultSchema}.TaskType ADD
    ...
    CONSTRAINT FK_TaskType_OnRejectAction FOREIGN KEY (OnRejectActionID) REFERENCES ${mjSchema}.[Action](ID),
    CONSTRAINT FK_TaskType_OnCancelAction FOREIGN KEY (OnCancelActionID) REFERENCES ${mjSchema}.[Action](ID);
GO

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Action invoked when a task of this type transitions to a rejected decision (post-commit, non-blocking). Used by approval workflows.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskType',
    @level2type = N'COLUMN', @level2name = N'OnRejectActionID';
GO
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Action invoked when a task of this type transitions to Cancelled (post-commit, non-blocking).',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'TaskType',
    @level2type = N'COLUMN', @level2name = N'OnCancelActionID';
GO
...
---------------------------------------------------------------------------
ALTER TABLE ${flyway:defaultSchema}.TaskActivity DROP CONSTRAINT CK_TaskActivity_Type;
GO
ALTER TABLE ${flyway:defaultSchema}.TaskActivity ADD CONSTRAINT CK_TaskActivity_Type CHECK (ActivityType IN (
