...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskCategory (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    ...
    CONSTRAINT FK_TaskCategory_Parent FOREIGN KEY (ParentID) REFERENCES ${flyway:defaultSchema}.TaskCategory(ID)
);
GO
...
CREATE TABLE ${flyway:defaultSchema}.Task (
    ...
    OverdueNotifiedAt DATETIMEOFFSET,
    CONSTRAINT PK_Task PRIMARY KEY (ID),
    CONSTRAINT FK_Task_Type FOREIGN KEY (TypeID) REFERENCES ${flyway:defaultSchema}.TaskType(ID),
    CONSTRAINT FK_Task_Category FOREIGN KEY (CategoryID) REFERENCES ${flyway:defaultSchema}.TaskCategory(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskRole (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    Name NVARCHAR(100) NOT NULL,
    Description NVARCHAR(MAX),
    Sequence INT NOT NULL DEFAULT 100,
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskAssignment (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    ...
    CONSTRAINT FK_TaskAssignment_Task FOREIGN KEY (TaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
    CONSTRAINT FK_TaskAssignment_AssigneeEntity FOREIGN KEY (AssigneeEntityID) REFERENCES ${mjSchema}.Entity(ID),
    CONSTRAINT FK_TaskAssignment_Role FOREIGN KEY (RoleID) REFERENCES ${flyway:defaultSchema}.TaskRole(ID),
...
CREATE TABLE ${flyway:defaultSchema}.TaskDependency (
    ...
    CONSTRAINT FK_TaskDependency_DependsOnTask FOREIGN KEY (DependsOnTaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskTag (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    Name NVARCHAR(100) NOT NULL,
    ColorCode NVARCHAR(20),
    Description NVARCHAR(MAX),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskTagLink (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    TaskID UNIQUEIDENTIFIER NOT NULL,
    TagID UNIQUEIDENTIFIER NOT NULL,
    CONSTRAINT PK_TaskTagLink PRIMARY KEY (ID),
    CONSTRAINT FK_TaskTagLink_Task FOREIGN KEY (TaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
    CONSTRAINT FK_TaskTagLink_Tag FOREIGN KEY (TagID) REFERENCES ${flyway:defaultSchema}.TaskTag(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskComment (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    TaskID UNIQUEIDENTIFIER NOT NULL,
    ParentID UNIQUEIDENTIFIER,
    ...
    CONSTRAINT FK_TaskComment_Task FOREIGN KEY (TaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
    CONSTRAINT FK_TaskComment_Parent FOREIGN KEY (ParentID) REFERENCES ${flyway:defaultSchema}.TaskComment(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskTemplate (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    Name NVARCHAR(255) NOT NULL,
    Description NVARCHAR(MAX),
    CategoryID UNIQUEIDENTIFIER,
    ...
    CONSTRAINT FK_TaskTemplate_Category FOREIGN KEY (CategoryID) REFERENCES ${flyway:defaultSchema}.TaskCategory(ID),
    CONSTRAINT FK_TaskTemplate_Type FOREIGN KEY (TypeID) REFERENCES ${flyway:defaultSchema}.TaskType(ID)
);
GO
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskTemplateItem (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    ...
    CONSTRAINT FK_TaskTemplateItem_Template FOREIGN KEY (TemplateID) REFERENCES ${flyway:defaultSchema}.TaskTemplate(ID),
    CONSTRAINT FK_TaskTemplateItem_Parent FOREIGN KEY (ParentItemID) REFERENCES ${flyway:defaultSchema}.TaskTemplateItem(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskTemplateItemDependency (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    ItemID UNIQUEIDENTIFIER NOT NULL,
    DependsOnItemID UNIQUEIDENTIFIER NOT NULL,
    DependencyType NVARCHAR(50) NOT NULL DEFAULT 'FinishToStart',
    CONSTRAINT PK_TaskTemplateItemDependency PRIMARY KEY (ID),
    CONSTRAINT FK_TaskTemplateItemDep_Item FOREIGN KEY (ItemID) REFERENCES ${flyway:defaultSchema}.TaskTemplateItem(ID),
    CONSTRAINT FK_TaskTemplateItemDep_DependsOn FOREIGN KEY (DependsOnItemID) REFERENCES ${flyway:defaultSchema}.TaskTemplateItem(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskTemplateItemRole (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    ItemID UNIQUEIDENTIFIER NOT NULL,
    RoleID UNIQUEIDENTIFIER NOT NULL,
    CONSTRAINT PK_TaskTemplateItemRole PRIMARY KEY (ID),
    CONSTRAINT FK_TaskTemplateItemRole_Item FOREIGN KEY (ItemID) REFERENCES ${flyway:defaultSchema}.TaskTemplateItem(ID),
    CONSTRAINT FK_TaskTemplateItemRole_Role FOREIGN KEY (RoleID) REFERENCES ${flyway:defaultSchema}.TaskRole(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskActivity (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    TaskID UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT FK_TaskActivity_Task FOREIGN KEY (TaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskNotificationConfig (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    ...
    CONSTRAINT FK_TaskNotificationConfig_TaskType FOREIGN KEY (TaskTypeID) REFERENCES ${flyway:defaultSchema}.TaskType(ID),
...
---------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.TaskNotificationLog (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    TaskID UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT FK_TaskNotificationLog_Task FOREIGN KEY (TaskID) REFERENCES ${flyway:defaultSchema}.Task(ID),
