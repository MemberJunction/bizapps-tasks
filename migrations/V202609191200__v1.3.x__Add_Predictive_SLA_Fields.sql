-- BizAppsTasks: Add Predictive SLA Breach Outcome Columns & Engineered View Features
-- Materialized columns for Predictive Studio SLA breach classification and operational sorting/filtering.
...
ALTER TABLE ${flyway:defaultSchema}.Task ADD
    ...
    CONSTRAINT CK_Task_PredictedSLARiskBand CHECK (PredictedSLARiskBand IN ('Low', 'Medium', 'High', 'Critical'));
GO
...
---------------------------------------------------------------------------
-- 2. Update vwTasks: include engineered relational & temporal training features
---------------------------------------------------------------------------
UPDATE [${mjSchema}].[Entity]
SET [BaseViewGenerated] = 0
WHERE [ID] = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466';
GO
...
SELECT
    ...
    CASE 
        WHEN t.[CompletedAt] IS NOT NULL AND t.[DueAt] IS NOT NULL THEN 
            CASE WHEN t.[CompletedAt] > t.[DueAt] THEN 'Breached' ELSE 'Met' END
        ELSE NULL 
    END AS [IsSLABreached],
    CASE 
        WHEN t.[StartedAt] IS NOT NULL AND t.[DueAt] IS NOT NULL THEN 
            DATEDIFF(day, t.[StartedAt], t.[DueAt]) 
        WHEN t.[__mj_CreatedAt] IS NOT NULL AND t.[DueAt] IS NOT NULL THEN 
            DATEDIFF(day, t.[__mj_CreatedAt], t.[DueAt]) 
        ELSE NULL 
    END AS [LeadDays],
    ISNULL((SELECT COUNT(*) FROM [${flyway:defaultSchema}].[TaskAssignment] ta WHERE ta.[TaskID] = t.[ID]), 0) AS [AssignmentsCount],
    ISNULL((SELECT COUNT(*) FROM [${flyway:defaultSchema}].[TaskComment] tc WHERE tc.[TaskID] = t.[ID]), 0) AS [CommentsCount]
FROM
...
/* SQL text to insert 7 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '33d3756e-8ac7-4a57-be61-946d1ae7c2d6' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'PredictedSLABreachProbability')) BEGIN
         ...
         (
            ...
            (SELECT COALESCE(MAX([Sequence]), 0) + 1 FROM [${mjSchema}].[EntityField] WHERE [EntityID] = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466'),
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '54214dda-792c-4a7a-a6c0-115ba1c90aab' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'PredictedSLARiskBand')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'a92eaf03-b039-4dc4-931c-8c6d7c038217' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'PredictedSLAScoredAt')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'e7737a78-1c54-4766-929c-bfe8ddf0555c' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'IsSLABreached')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '35141732-5d6a-459a-a2fa-76808f95160b' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'LeadDays')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'aad50345-db1b-4bc8-8515-979137c33382' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'AssignmentsCount')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '45355317-a1ab-468f-8901-4564b03ccc4b' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'CommentsCount')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '9e82d5eb-b2ac-458f-8c8e-fb2dfee82244' OR (EntityID = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND Name = 'RootParentID')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
EXEC [${mjSchema}].[spDeleteUnneededEntityFields] @ExcludedSchemaNames='', @EntityIDs='B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466', @IncludedSchemaNames='${flyway:defaultSchema}';

/* SQL text to update existing entity fields from schema (1 scoped entities) */
EXEC [${mjSchema}].[spUpdateExistingEntityFieldsFromSchema] @ExcludedSchemaNames='', @EntityIDs='B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466', @IncludedSchemaNames='${flyway:defaultSchema}';
...
IF NOT EXISTS (
      SELECT 1 FROM [${mjSchema}].[EntitySetting] WHERE [EntityID] = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND [Name] = 'FieldCategoryInfo'
   )
   BEGIN
      INSERT INTO [${mjSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('9aa482c3-1a7f-53ba-9040-cdb96c79943c', 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466', 'FieldCategoryInfo', '{
  "Ownership and Audit": {
...
IF NOT EXISTS (
      SELECT 1 FROM [${mjSchema}].[EntitySetting] WHERE [EntityID] = 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466' AND [Name] = 'FieldCategoryIcons'
   )
   BEGIN
      INSERT INTO [${mjSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('190fe5f2-3423-5e28-82d8-f35fb65f7ae8', 'B348FFA2-B1A7-4AC2-B6FD-F4E0C0697466', 'FieldCategoryIcons', '{
